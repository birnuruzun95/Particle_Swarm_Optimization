...
def result_yatay():
    ...
    for x in range(0,len(result_ym)):
        for y in range(0,len(result_ym[0])):
            result_ym[x][y] = float(mesafe + yangin_ym[x][y] + (scdm_ym[x][y]/mesafe) - (0.3*isik_ym[x][y]))
...
def result_dikey():
    ...
    for x in range(0,len(result_dm)):
        for y in range(0,len(result_dm[0])):
            result_dm[x][y] = float(mesafe + yangin_dm[x][y] + (scdm_dm[x][y]/mesafe) - (0.3*isik_dm[x][y]))
